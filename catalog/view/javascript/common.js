...
// Catalog Product Card - Image gallery
...
var catalogProductCardController = {
	...
	'init': function() {
        ...
        $('.colors-mfp').magnificPopup({
            delegate: 'a',
            type: 'image',
            mainClass: 'mfp-with-zoom'
		});
	},
	'initCard': function(cardIndex, colors = false) {
...
$(document).ready(function() {
	catalogProductCardController.init();
});