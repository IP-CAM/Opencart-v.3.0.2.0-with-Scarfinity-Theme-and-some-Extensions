<?php
class ControllerCheckoutRequisites extends Controller {
	public function index() {
        ...
        $data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('checkout/requsites', '', true)
		);
		...
		$this->response->setOutput($this->load->view('checkout/requisites', $data));
	}
}